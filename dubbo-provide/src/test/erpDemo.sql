...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='品牌资料';
...
INSERT INTO `bug` VALUES ('17', 'I', '123123', '123', 'desTest', '2013-06-23 18:57:43', '2013-06-23 18:58:16', '1', '1');
...
INSERT INTO `bug` VALUES ('23', 'I', '12312', 'test', '<a href=\"/erp/attached/2013/06/24/0e7b2ea75eb741a8beeb709db9dee03a.zip\">srca12306.zip</a>3123123<a href=\"/erp/attached/2013/06/24/f6415de04f6e4c9eb0170742c14cb553.docx\">笔试参考题目3.docx</a>', '2013-06-24 09:06:01', '2013-08-05 10:09:56', '1', '1');
...
INSERT INTO `bug` VALUES ('26', 'A', '1212', 'tttt', '121212', '2017-11-28 18:53:47', '2017-11-28 18:53:47', '1', '1');
INSERT INTO `bug` VALUES ('27', 'A', '33333', 'test2222', '333333444', '2017-11-28 19:49:46', '2017-11-28 19:49:46', '1', '1');
INSERT INTO `bug` VALUES ('28', 'A', '12', 'zh', '34www', '2017-11-28 19:51:13', '2017-11-28 19:51:13', '1', '1');
INSERT INTO `bug` VALUES ('29', 'A', 'zh222', '只22', '22', '2017-11-28 19:52:51', '2017-11-28 19:52:51', '1', '1');
INSERT INTO `bug` VALUES ('30', 'A', '点哇点哇', '恢复和家人不会加班', 'ad我的娃多哇', '2017-11-28 19:54:00', '2017-11-28 19:54:00', '1', '1');
INSERT INTO `bug` VALUES ('31', 'A', '点哇点哇', '恢复和家人不会加班', 'ad我的娃多哇', '2017-11-28 19:54:10', '2017-11-28 19:54:10', '1', '1');
INSERT INTO `bug` VALUES ('32', 'A', '单位', '点哇爱我的哇', '点哇点哇&nbsp;', '2017-11-28 19:55:07', '2017-11-28 19:55:07', '1', '1');
INSERT INTO `bug` VALUES ('33', 'A', '吞吞吐吐', '吞吞吐吐', '吞吞吐吐', '2017-11-28 19:56:08', '2017-11-28 19:56:08', '1', '1');
INSERT INTO `bug` VALUES ('34', 'A', '有意义', '一样一样', '更多人更多&nbsp;', '2017-11-28 19:58:23', '2017-11-28 19:58:23', '1', '1');
INSERT INTO `bug` VALUES ('35', 'A', '呜呜呜呜', '热热热', '呃呃呃呃', '2017-11-28 20:06:54', '2017-11-28 20:06:54', '1', '1');
...
CREATE TABLE `city` (
  ...
  `MODIFYER` int(10) default NULL COMMENT '修改人',
  PRIMARY KEY  (`CITY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='城市资料';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='公司资料表';

-- ----------------------------
-- Records of company_info
-- ----------------------------
INSERT INTO `company_info` VALUES ('1', 'uu11', 't', 'tttt', 't', null, 'tttt@qq.com', 't', 'I', '2013-05-09', '2017-11-29', null, null, null, 't', null, '1');
...
INSERT INTO `company_info` VALUES ('35', 'zh666', '66666', '000000', '我的骄傲的佳绩就', null, '开门我的卡吗娃狂魔的', '大开挖面打开马克', 'A', '2017-11-29', '2017-11-29', null, null, null, '昂科威带你们看夸我吗', '1', '1');
INSERT INTO `company_info` VALUES ('36', '哈哈哈', '5555', '555555555', '555555555555', null, '5555555555', '555555555555', 'A', '2017-11-29', '2017-11-29', null, null, null, '5555555555555', '1', '1');
...
CREATE TABLE `operationlogs` (
  `operlogid` varchar(255) NOT NULL,
  `computerIp` varchar(255) default NULL,
  `computerName` varchar(255) default NULL,
  `haoshi` varchar(255) default NULL,
  `operMethod` varchar(255) default NULL,
  `operParams` varchar(255) default NULL,
  `operURI` varchar(255) default NULL,
  `opercontroller` varchar(255) default NULL,
  `operloginId` varchar(255) default NULL,
  `operlognsolr` varchar(255) default NULL,
  `opertime` varchar(255) default NULL,
  `tomcatport` int(11) default NULL,
  PRIMARY KEY  (`operlogid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组织部门资料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='参数资料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限资料表';
...
-- ----------------------------
-- Table structure for `permission_copy`
-- ----------------------------
DROP TABLE IF EXISTS `permission_copy`;
CREATE TABLE `permission_copy` (
  `PERMISSION_ID` int(11) NOT NULL auto_increment COMMENT '权限代码',
  `PID` int(11) default NULL,
  `NAME` varchar(100) default NULL,
  `PNAME` varchar(100) default NULL,
...
-- ----------------------------
-- Records of permission_copy
-- ----------------------------
INSERT INTO `permission_copy` VALUES ('1', null, '系统管理', '', '0', 'sysMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-sys', 'A', '系统管理', '2013-05-23 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('2', '1', '程式管理', '系统管理', '0', 'funMgr', 'F', 'Y', 'closed', 'jsp/function/functionMain.jsp', 'icon-pro', 'A', '程式管理', '2013-05-23 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('3', null, '公司管理', '', '0', 'compMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-comp', 'A', '公司管理', '2013-05-23 00:00:00', '2013-06-20 15:33:13', '1', '1');
INSERT INTO `permission_copy` VALUES ('4', '1', '数据库管理', '系统管理', '2', '1123', 'F', 'Y', 'open', 'druid/index.html', 'icon-db', 'A', '123123123123123123', '2013-05-23 00:00:00', '2013-06-20 15:08:45', '1', '1');
INSERT INTO `permission_copy` VALUES ('6', null, '物料管理', '', '1', 'itemMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-item', 'A', '', '2013-05-23 00:00:00', '2013-08-05 10:09:30', '1', '1');
INSERT INTO `permission_copy` VALUES ('7', '1', '权限分派', '系统管理', '3', 'funOMgr', 'F', 'Y', 'closed', 'jsp/permission/permissionAssignmentMain.jsp', 'icon-config', 'A', '菜单功能分派', '2013-05-23 00:00:00', '2013-06-22 09:15:57', '1', '1');
INSERT INTO `permission_copy` VALUES ('8', '6', '物料档案录入', '物料管理', '2', 'itemMain', 'F', 'Y', 'closed', 'jsp/itemManager/itemMain.jsp', 'icon-item', 'A', '', '2013-05-23 00:00:00', '2013-06-27 09:18:02', '1', '1');
INSERT INTO `permission_copy` VALUES ('10', '3', '公司档案录入', '公司管理', '0', 'compMain', 'F', 'Y', 'closed', 'jsp/company/companyMain.jsp', 'icon-edit', 'A', '公司维护页面', '2013-05-24 00:00:00', '2013-06-27 08:46:23', '1', '1');
INSERT INTO `permission_copy` VALUES ('11', '10', '公司新增', '公司管理', '1', 'compAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '公司新增', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('12', '10', '公司编辑', '公司管理', '2', 'compEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '公司编辑', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('13', '10', '公司删除', '公司管理', '3', 'compDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '公司删除', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('14', '10', '公司结束编辑', '公司管理', '4', 'compEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '结束编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('15', '10', '公司保存', '公司管理', '5', 'compSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '保存', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('16', '2', '菜单功能新增', '系统管理', '4', 'funAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '菜单功能新增', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('17', '2', '菜单功能编辑', '系统管理', '5', 'funEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '菜单功能编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('18', '2', '菜单功能删除', '系统管理', '6', 'funDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '菜单功能删除', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('19', '2', '菜单结束编辑', '系统管理', '7', 'funEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '结束编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('20', '2', '菜单保存', '系统管理', '8', 'funSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '保存', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('21', '7', '权限分配保存', '系统管理', '9', 'perConfig', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '权限分配保存', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('22', '7', '角色新增', '系统管理', '10', 'roleAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-role', 'A', '角色新增', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('23', '7', '角色编辑', '系统管理', '11', 'roleEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '角色编辑', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('24', '7', '角色删除', '系统管理', '12', 'roleDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '角色删除', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('25', '7', '角色结束编辑', '系统管理', '13', 'roleEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '角色结束编辑', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('26', '7', '角色保存', '系统管理', '14', 'roleSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '角色保存', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('27', '1', '用户管理', '系统管理', '15', 'userMain', 'F', 'Y', 'closed', 'jsp/user/userMain.jsp', 'icon-adds', 'A', '用户管理', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('28', '1', '用户角色分派', '系统管理', '16', 'userRoleMgr', 'F', 'Y', 'closed', 'jsp/roleConfig/roleConfigMain.jsp', 'icon-role', 'A', '用户角色分配', '2013-05-27 00:00:00', '2013-06-22 09:16:35', '1', '1');
INSERT INTO `permission_copy` VALUES ('29', '27', '用户新增', '用户管理', '16', 'userAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '123123123123', '2013-05-27 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('30', '27', '用户编辑', '系统管理', '17', 'userEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('31', '27', '用户删除', '系统管理', '18', 'userDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('32', '27', '用户结束编辑', '系统管理', '19', 'userEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-end', 'I', '', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('33', '27', '用户保存', '系统管理', '20', 'userSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('34', '28', '用户角色分派', '系统管理', '21', 'userRoleConfig', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '用户角色分派', '2013-05-29 00:00:00', '2013-05-29 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('35', '2', '123', '程式管理', '1', '123', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'I', '123123', '2013-06-13 00:00:00', '2013-06-13 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('36', '27', '用户del', '用户管理', '1', '123', 'F', 'Y', 'closed', '123', 'icon-cancel', 'I', '123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('37', '27', '用户delll', '用户管理', '123', '123', 'O', 'Y', 'open', '123', 'icon-undo', 'I', '123123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('38', '4', 'ttttt', '数据库管理', '123', '123123123123', 'F', 'N', 'closed', '123', 'icon-undo', 'I', '123123123123123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('39', null, '1123123', '', '123', '123123', 'F', 'Y', 'closed', '32123', 'icon-edit', 'I', '123123123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('40', '1', '组织管理', '系统管理', '6', 'orgzMgr', 'F', 'Y', 'closed', 'jsp/organization/organizationMain.jsp', 'icon-tip', 'A', '组织管理', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('41', '40', '组织增加', '组织管理', '0', 'orgzAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('42', '40', '组织编辑', '组织管理', '1', 'orgzEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-17 00:00:00', '2013-06-17 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('43', '40', '组织删除', '组织管理', '2', 'orgzDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-17 00:00:00', '2013-06-17 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('44', '1', '日志管理', '系统管理', '45', 'logMgr', 'F', 'Y', 'closed', 'jsp/logs/logsMain.jsp', 'icon-pro', 'A', '日志管理', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('45', null, '123123', '', '123', '123', 'F', 'Y', 'closed', '123', '', 'I', '123123123', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('46', '1', '123123', '系统管理', '123', '2312', 'F', 'Y', 'closed', '1231', 'icon-back', 'I', '3123123123123', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('47', '44', '日志新增', '日志管理', '1', 'logAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('48', '44', '日志编辑', '日志管理', '2', 'logEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('49', '44', '日志删除', '日志管理', '3', 'logDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('50', '1', '数据字典', '系统管理', '5', 'dicMgr', 'F', 'Y', 'closed', 'jsp/systemCode/systemCodeMain.jsp', 'icon-undo', 'A', '', '2013-06-19 00:00:00', '2013-06-19 14:12:08', '1', '1');
INSERT INTO `permission_copy` VALUES ('51', '50', '字典新增', '数据字典', '0', 'dicAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('52', '50', '字典编辑', '数据字典', '1', 'dicEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('53', '50', '字典删除', '数据字典', '2', 'dicDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('54', '4', '123', '数据库管理', '123', '123', 'O', 'Y', 'open', '123', 'icon-edit', 'I', '123123123123', '2013-06-20 15:06:08', '2013-06-20 15:13:33', '1', '1');
INSERT INTO `permission_copy` VALUES ('55', '4', '12312311', '数据库管理', '123', '123', 'O', 'Y', 'closed', '123', '', 'I', '123123123123123123123', '2013-06-20 15:08:01', '2013-06-20 15:10:13', '1', '1');
INSERT INTO `permission_copy` VALUES ('56', '4', '12312311', '数据库管理', '123123', '123', 'O', 'Y', 'open', '1231', 'icon-back', 'I', '23123123', '2013-06-20 15:10:29', '2013-06-20 15:13:35', '1', '1');
INSERT INTO `permission_copy` VALUES ('57', null, '阿斯蒂芬', '', '123123', '123', 'F', 'Y', 'closed', '123', 'icon-cancel', 'I', '123123123', '2013-06-20 15:19:50', '2013-06-20 15:20:42', '1', '1');
INSERT INTO `permission_copy` VALUES ('58', '57', '123', '阿斯蒂芬', '123', '123123', 'F', 'Y', 'closed', '123', '', 'I', '123123', '2013-06-20 15:20:06', '2013-06-20 15:20:37', '1', '1');
INSERT INTO `permission_copy` VALUES ('59', '1', '参数设置', '系统管理', '12', '11', 'F', 'Y', 'closed', 'jsp/sysParameter/sysParameterMain.jsp', 'icon-remove', 'A', '111', '2013-06-21 12:14:27', '2013-06-21 12:21:13', '1', '1');
INSERT INTO `permission_copy` VALUES ('60', '59', '结束编辑', '参数设置', '1', 'parEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-end', 'A', '', '2013-06-22 09:23:01', '2013-06-22 09:23:01', '1', '1');
INSERT INTO `permission_copy` VALUES ('61', '59', '删除', '参数设置', '2', 'parDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-22 09:23:47', '2013-06-22 09:24:23', '1', '1');
INSERT INTO `permission_copy` VALUES ('62', '59', '保存', '参数设置', '3', 'parSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'A', '', '2013-06-22 09:25:11', '2013-06-22 09:25:57', '1', '1');
INSERT INTO `permission_copy` VALUES ('63', '1', 'Bug管理', '系统管理', '9', 'bugMgr', 'F', 'Y', 'closed', 'jsp/bugManager/bugMain.jsp', 'icon-bug', 'A', '', '2013-06-22 09:45:45', '2013-06-22 14:37:19', '1', '1');
INSERT INTO `permission_copy` VALUES ('64', '63', 'Bug新增', 'Bug管理', '9', 'bugAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-badd', 'A', '123123', '2013-06-22 10:04:54', '2013-06-22 10:43:51', '1', '1');
INSERT INTO `permission_copy` VALUES ('65', '63', 'Bug编辑', 'Bug管理', '10', 'bugEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-bedit', 'A', '', '2013-06-22 10:05:34', '2013-06-22 10:05:34', '1', '1');
INSERT INTO `permission_copy` VALUES ('66', '63', 'Bug删除', 'Bug管理', '11', 'bugDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-bdel', 'A', '', '2013-06-22 10:06:12', '2013-06-22 10:06:12', '1', '1');
INSERT INTO `permission_copy` VALUES ('67', '1', 'test', '系统管理', '1', '123', 'F', 'Y', 'closed', 'jsp/bugManager/MyJsp.jsp', 'icon-bdel', 'I', '', '2013-06-22 15:54:10', '2013-06-22 22:31:02', '1', '1');
INSERT INTO `permission_copy` VALUES ('68', null, '客户管理', '', '3', 'cstMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-role', 'A', '', '2013-06-24 09:45:45', '2013-06-24 09:45:45', '1', '1');
INSERT INTO `permission_copy` VALUES ('69', '68', '客户档案录入', '客户管理', '1', 'cstMain', 'F', 'Y', 'closed', 'jsp/cstManager/cstMain.jsp', 'icon-edit', 'A', '123123123123', '2013-06-24 09:46:49', '2013-06-26 16:27:56', '1', '1');
INSERT INTO `permission_copy` VALUES ('70', '69', '客户新增', '客户管理', '1', 'cstAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 12:20:09', '2013-06-26 12:20:09', '1', '1');
INSERT INTO `permission_copy` VALUES ('71', '69', '客户编辑', '客户管理', '2', 'cstEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 12:20:46', '2013-06-26 12:21:22', '1', '1');
INSERT INTO `permission_copy` VALUES ('72', '69', '客户删除', '客户管理', '3', 'cstDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-26 12:22:05', '2013-06-26 12:22:05', '1', '1');
INSERT INTO `permission_copy` VALUES ('73', '69', '客户联系人编辑', '客户管理', '4', 'cstConEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-26 12:23:15', '2013-06-26 12:23:15', '1', '1');
INSERT INTO `permission_copy` VALUES ('74', null, '供应商管理', '', '5', 'supMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-role', 'A', '', '2013-06-26 12:27:50', '2013-06-26 12:29:22', '1', '1');
INSERT INTO `permission_copy` VALUES ('75', '74', '供应商档案录入', '供应商管理', '1', 'supMain', 'F', 'Y', 'closed', 'jsp/supManager/supMain.jsp', 'icon-tip', 'A', '', '2013-06-26 12:28:55', '2013-06-26 16:28:17', '1', '1');
INSERT INTO `permission_copy` VALUES ('76', '75', '供应商新增', '供应商管理', '1', 'supAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 12:30:25', '2013-06-26 12:30:25', '1', '1');
INSERT INTO `permission_copy` VALUES ('77', '75', '供应商编辑', '供应商管理', '2', 'supEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 12:31:10', '2013-06-26 12:31:10', '1', '1');
INSERT INTO `permission_copy` VALUES ('78', '75', '供应商删除', '供应商管理', '3', 'supDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-26 12:31:59', '2013-06-26 14:05:55', '1', '1');
INSERT INTO `permission_copy` VALUES ('79', '75', '供应商联系人编辑', '供应商管理', '4', 'supConEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-26 14:06:44', '2013-06-26 15:45:59', '1', '1');
INSERT INTO `permission_copy` VALUES ('80', '8', '商品新增', '商品管理', '1', 'itemAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 15:37:38', '2013-06-26 15:37:38', '1', '1');
INSERT INTO `permission_copy` VALUES ('81', '8', '商品编辑', '商品管理', '2', 'itemEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 15:38:10', '2013-06-26 15:38:21', '1', '1');
INSERT INTO `permission_copy` VALUES ('82', '8', '商品删除', '商品管理', '3', 'itemDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-26 15:38:59', '2013-06-26 15:39:18', '1', '1');
INSERT INTO `permission_copy` VALUES ('83', '8', '商品导入', '商品管理', '4', 'itemImport', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-excel', 'I', '', '2013-06-26 15:41:54', '2013-06-26 16:30:12', '1', '1');
INSERT INTO `permission_copy` VALUES ('84', '68', '客户档案导入', '客户管理', '2', 'cstImport', 'F', 'Y', 'closed', 'sdf', 'icon-excel', 'A', '', '2013-06-26 16:27:14', '2013-06-26 16:27:14', '1', '1');
INSERT INTO `permission_copy` VALUES ('85', '74', '供应商档案导入', '供应商管理', '2', 'supImport', 'F', 'Y', 'closed', 'sdf', 'icon-excel', 'A', '', '2013-06-26 16:29:04', '2013-06-26 16:29:04', '1', '1');
INSERT INTO `permission_copy` VALUES ('86', '6', '物料档案导入', '物料管理', '2', 'itemImport', 'F', 'Y', 'closed', 'jsp/docView/view.jsp', 'icon-excel', 'A', '', '2013-06-26 16:31:43', '2013-07-12 12:14:15', '1', '1');
INSERT INTO `permission_copy` VALUES ('87', null, '项目管理', '', '5', 'projectMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-sys', 'A', '', '2013-06-27 12:02:43', '2013-06-27 12:02:43', '1', '1');
INSERT INTO `permission_copy` VALUES ('88', '87', '项目档案录入', '项目管理', '1', 'projectMain', 'F', 'Y', 'closed', 'jsp/project/projectMain.jsp', 'icon-adds', 'A', '', '2013-06-27 12:03:59', '2013-06-27 12:03:59', '1', '1');
INSERT INTO `permission_copy` VALUES ('89', '88', '项目新增', '项目档案录入', '1', 'projectAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-27 12:04:39', '2013-06-27 12:04:53', '1', '1');
INSERT INTO `permission_copy` VALUES ('90', '88', '项目编辑', '项目档案录入', '2', 'projectEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-27 12:05:28', '2013-06-27 12:05:28', '1', '1');
INSERT INTO `permission_copy` VALUES ('91', '88', '项目删除', '项目档案录入', '3', 'projectDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-27 12:06:08', '2013-07-01 10:59:53', '1', '1');
INSERT INTO `permission_copy` VALUES ('92', null, '数据备份', '', '7', 'dbBackUp', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-db', 'A', '', '2013-06-28 13:32:09', '2013-06-28 13:32:22', '1', '1');
INSERT INTO `permission_copy` VALUES ('93', '92', '数据备份', '数据备份', '1', 'dbBackUpMain', 'F', 'Y', 'closed', 'jsp/dbBackUp/dbBackUpMain.jsp', 'icon-end', 'A', '', '2013-06-28 13:34:21', '2013-06-28 13:50:29', '1', '1');
INSERT INTO `permission_copy` VALUES ('94', '93', '手动备份', '数据备份', '1', 'dbBackUpHand', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-pro', 'A', '', '2013-06-28 13:37:27', '2013-07-11 11:23:27', '1', '1');
INSERT INTO `permission_copy` VALUES ('95', '93', '定时备份', '数据备份', '2', 'dbBackUpTime', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-28 13:38:19', '2013-06-28 13:38:19', '1', '1');
INSERT INTO `permission_copy` VALUES ('96', '74', '采购单录入', '供应商管理', '3', 'ordPurMgr', 'F', 'Y', 'closed', 'jsp/orderPurchase/orderPurchaseMain.jsp', 'icon-adds', 'A', '', '2013-07-01 10:58:03', '2013-07-01 10:58:03', '1', '1');
INSERT INTO `permission_copy` VALUES ('97', '96', '采购单新增', '采购单录入', '1', 'ordPurAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-07-01 10:58:58', '2013-07-01 10:58:58', '1', '1');
INSERT INTO `permission_copy` VALUES ('98', '96', '采购单编辑', '采购单录入', '2', 'ordPurEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-07-01 10:59:44', '2013-07-01 11:01:00', '1', '1');
INSERT INTO `permission_copy` VALUES ('99', '96', '采购单删除', '采购单录入', '3', 'ordPurDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-07-01 11:00:44', '2013-07-01 11:00:44', '1', '1');
INSERT INTO `permission_copy` VALUES ('100', '68', '客户订单录入', '客户管理', '3', 'cstOrderMgr', 'F', 'Y', 'closed', 'jsp/orderSale/orderSaleMain.jsp', 'icon-end', 'A', '', '2013-07-08 15:20:54', '2013-07-08 15:23:53', '1', '1');

-- ----------------------------
-- Table structure for `permission_leng`
-- ----------------------------
DROP TABLE IF EXISTS `permission_leng`;
CREATE TABLE `permission_leng` (
  `PERMISSION_ID` int(11) NOT NULL auto_increment COMMENT '权限代码',
  `PID` int(11) default NULL,
  `NAME` varchar(100) default NULL,
  `PNAME` varchar(100) default NULL,
...
-- ----------------------------
-- Records of permission_leng
-- ----------------------------
INSERT INTO `permission_leng` VALUES ('1', '0', '系统管理', '', '0', 'sysMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-sys', 'A', '系统管理', '2013-05-23 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('2', '1', '程式管理', '系统管理', '0', 'funMgr', 'F', 'Y', 'closed', 'jsp/function/functionMain.jsp', 'icon-pro', 'A', '程式管理', '2013-05-23 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('3', '0', '公司管理', '', '0', 'compMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-comp', 'A', '公司管理', '2013-05-23 00:00:00', '2013-06-20 15:33:13', '1', '1');
INSERT INTO `permission_leng` VALUES ('4', '1', '数据库管理', '系统管理', '2', '1123', 'F', 'Y', 'open', 'druid/index.html', 'icon-db', 'A', '123123123123123123', '2013-05-23 00:00:00', '2013-06-20 15:08:45', '1', '1');
INSERT INTO `permission_leng` VALUES ('6', '0', '物料管理', '', '1', 'itemMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-item', 'A', '', '2013-05-23 00:00:00', '2013-08-05 10:09:30', '1', '1');
INSERT INTO `permission_leng` VALUES ('7', '1', '权限分派', '系统管理', '3', 'funOMgr', 'F', 'Y', 'closed', 'jsp/permission/permissionAssignmentMain.jsp', 'icon-config', 'A', '菜单功能分派', '2013-05-23 00:00:00', '2013-06-22 09:15:57', '1', '1');
INSERT INTO `permission_leng` VALUES ('8', '6', '物料档案录入', '物料管理', '2', 'itemMain', 'F', 'Y', 'closed', 'jsp/itemManager/itemMain.jsp', 'icon-item', 'A', '', '2013-05-23 00:00:00', '2013-06-27 09:18:02', '1', '1');
INSERT INTO `permission_leng` VALUES ('10', '3', '公司档案录入', '公司管理', '0', 'compMain', 'F', 'Y', 'closed', 'jsp/company/companyMain.jsp', 'icon-edit', 'A', '公司维护页面', '2013-05-24 00:00:00', '2013-06-27 08:46:23', '1', '1');
INSERT INTO `permission_leng` VALUES ('11', '10', '公司新增', '公司管理', '1', 'compAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '公司新增', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('12', '10', '公司编辑', '公司管理', '2', 'compEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '公司编辑', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('13', '10', '公司删除', '公司管理', '3', 'compDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '公司删除', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('14', '10', '公司结束编辑', '公司管理', '4', 'compEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '结束编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('15', '10', '公司保存', '公司管理', '5', 'compSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '保存', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('16', '2', '菜单功能新增', '系统管理', '4', 'funAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '菜单功能新增', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('17', '2', '菜单功能编辑', '系统管理', '5', 'funEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '菜单功能编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('18', '2', '菜单功能删除', '系统管理', '6', 'funDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '菜单功能删除', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('19', '2', '菜单结束编辑', '系统管理', '7', 'funEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '结束编辑', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('20', '2', '菜单保存', '系统管理', '8', 'funSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '保存', '2013-05-24 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('21', '7', '权限分配保存', '系统管理', '9', 'perConfig', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '权限分配保存', '2013-05-24 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('22', '7', '角色新增', '系统管理', '10', 'roleAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-role', 'A', '角色新增', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('23', '7', '角色编辑', '系统管理', '11', 'roleEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '角色编辑', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('24', '7', '角色删除', '系统管理', '12', 'roleDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '角色删除', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('25', '7', '角色结束编辑', '系统管理', '13', 'roleEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'I', '角色结束编辑', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('26', '7', '角色保存', '系统管理', '14', 'roleSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '角色保存', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('27', '1', '用户管理', '系统管理', '15', 'userMain', 'F', 'Y', 'closed', 'jsp/user/userMain.jsp', 'icon-adds', 'A', '用户管理', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('28', '1', '用户角色分派', '系统管理', '16', 'userRoleMgr', 'F', 'Y', 'closed', 'jsp/roleConfig/roleConfigMain.jsp', 'icon-role', 'A', '用户角色分配', '2013-05-27 00:00:00', '2013-06-22 09:16:35', '1', '1');
INSERT INTO `permission_leng` VALUES ('29', '27', '用户新增', '用户管理', '16', 'userAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '123123123123', '2013-05-27 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('30', '27', '用户编辑', '系统管理', '17', 'userEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('31', '27', '用户删除', '系统管理', '18', 'userDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-05-27 00:00:00', '2013-05-27 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('32', '27', '用户结束编辑', '系统管理', '19', 'userEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-end', 'I', '', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('33', '27', '用户保存', '系统管理', '20', 'userSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'I', '', '2013-05-27 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('34', '28', '用户角色分派', '系统管理', '21', 'userRoleConfig', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '用户角色分派', '2013-05-29 00:00:00', '2013-05-29 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('37', '27', '用户delll', '用户管理', '123', '123', 'O', 'Y', 'open', '123', 'icon-undo', 'I', '123123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('38', '4', 'ttttt', '数据库管理', '123', '123123123123', 'F', 'N', 'closed', '123', 'icon-undo', 'I', '123123123123123123', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('40', '1', '组织管理', '系统管理', '6', 'orgzMgr', 'F', 'Y', 'closed', 'jsp/organization/organizationMain.jsp', 'icon-tip', 'A', '组织管理', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('41', '40', '组织增加', '组织管理', '0', 'orgzAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('42', '40', '组织编辑', '组织管理', '1', 'orgzEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-17 00:00:00', '2013-06-17 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('43', '40', '组织删除', '组织管理', '2', 'orgzDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-17 00:00:00', '2013-06-17 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('44', '1', '日志管理', '系统管理', '45', 'logMgr', 'F', 'Y', 'closed', 'jsp/logs/logsMain.jsp', 'icon-pro', 'A', '日志管理', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('46', '1', '123123', '系统管理', '123', '2312', 'F', 'Y', 'closed', '1231', 'icon-back', 'I', '3123123123123', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('47', '44', '日志新增', '日志管理', '1', 'logAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('48', '44', '日志编辑', '日志管理', '2', 'logEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('49', '44', '日志删除', '日志管理', '3', 'logDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('50', '1', '数据字典', '系统管理', '5', 'dicMgr', 'F', 'Y', 'closed', 'jsp/systemCode/systemCodeMain.jsp', 'icon-undo', 'A', '', '2013-06-19 00:00:00', '2013-06-19 14:12:08', '1', '1');
INSERT INTO `permission_leng` VALUES ('51', '50', '字典新增', '数据字典', '0', 'dicAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('52', '50', '字典编辑', '数据字典', '1', 'dicEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('53', '50', '字典删除', '数据字典', '2', 'dicDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('54', '4', '123', '数据库管理', '123', '123', 'O', 'Y', 'open', '123', 'icon-edit', 'I', '123123123123', '2013-06-20 15:06:08', '2013-06-20 15:13:33', '1', '1');
INSERT INTO `permission_leng` VALUES ('55', '4', '12312311', '数据库管理', '123', '123', 'O', 'Y', 'closed', '123', '', 'I', '123123123123123123123', '2013-06-20 15:08:01', '2013-06-20 15:10:13', '1', '1');
INSERT INTO `permission_leng` VALUES ('56', '4', '12312311', '数据库管理', '123123', '123', 'O', 'Y', 'open', '1231', 'icon-back', 'I', '23123123', '2013-06-20 15:10:29', '2013-06-20 15:13:35', '1', '1');
INSERT INTO `permission_leng` VALUES ('58', '57', '123', '阿斯蒂芬', '123', '123123', 'F', 'Y', 'closed', '123', '', 'I', '123123', '2013-06-20 15:20:06', '2013-06-20 15:20:37', '1', '1');
INSERT INTO `permission_leng` VALUES ('59', '1', '参数设置', '系统管理', '12', '11', 'F', 'Y', 'closed', 'jsp/sysParameter/sysParameterMain.jsp', 'icon-remove', 'A', '111', '2013-06-21 12:14:27', '2013-06-21 12:21:13', '1', '1');
INSERT INTO `permission_leng` VALUES ('60', '59', '结束编辑', '参数设置', '1', 'parEndEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-end', 'A', '', '2013-06-22 09:23:01', '2013-06-22 09:23:01', '1', '1');
INSERT INTO `permission_leng` VALUES ('61', '59', '删除', '参数设置', '2', 'parDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-22 09:23:47', '2013-06-22 09:24:23', '1', '1');
INSERT INTO `permission_leng` VALUES ('62', '59', '保存', '参数设置', '3', 'parSave', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-save', 'A', '', '2013-06-22 09:25:11', '2013-06-22 09:25:57', '1', '1');
INSERT INTO `permission_leng` VALUES ('63', '1', 'Bug管理', '系统管理', '9', 'bugMgr', 'F', 'Y', 'closed', 'jsp/bugManager/bugMain.jsp', 'icon-bug', 'A', '', '2013-06-22 09:45:45', '2013-06-22 14:37:19', '1', '1');
INSERT INTO `permission_leng` VALUES ('64', '63', 'Bug新增', 'Bug管理', '9', 'bugAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-badd', 'A', '123123', '2013-06-22 10:04:54', '2013-06-22 10:43:51', '1', '1');
INSERT INTO `permission_leng` VALUES ('65', '63', 'Bug编辑', 'Bug管理', '10', 'bugEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-bedit', 'A', '', '2013-06-22 10:05:34', '2013-06-22 10:05:34', '1', '1');
INSERT INTO `permission_leng` VALUES ('66', '63', 'Bug删除', 'Bug管理', '11', 'bugDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-bdel', 'A', '', '2013-06-22 10:06:12', '2013-06-22 10:06:12', '1', '1');
INSERT INTO `permission_leng` VALUES ('67', '1', 'test', '系统管理', '1', '123', 'F', 'Y', 'closed', 'jsp/bugManager/MyJsp.jsp', 'icon-bdel', 'I', '', '2013-06-22 15:54:10', '2013-06-22 22:31:02', '1', '1');
INSERT INTO `permission_leng` VALUES ('68', '0', '客户管理', '', '3', 'cstMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-role', 'A', '', '2013-06-24 09:45:45', '2013-06-24 09:45:45', '1', '1');
INSERT INTO `permission_leng` VALUES ('69', '68', '客户档案录入', '客户管理', '1', 'cstMain', 'F', 'Y', 'closed', 'jsp/cstManager/cstMain.jsp', 'icon-edit', 'A', '123123123123', '2013-06-24 09:46:49', '2013-06-26 16:27:56', '1', '1');
INSERT INTO `permission_leng` VALUES ('70', '69', '客户新增', '客户管理', '1', 'cstAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 12:20:09', '2013-06-26 12:20:09', '1', '1');
INSERT INTO `permission_leng` VALUES ('71', '69', '客户编辑', '客户管理', '2', 'cstEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 12:20:46', '2013-06-26 12:21:22', '1', '1');
INSERT INTO `permission_leng` VALUES ('72', '69', '客户删除', '客户管理', '3', 'cstDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-26 12:22:05', '2013-06-26 12:22:05', '1', '1');
INSERT INTO `permission_leng` VALUES ('73', '69', '客户联系人编辑', '客户管理', '4', 'cstConEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-26 12:23:15', '2013-06-26 12:23:15', '1', '1');
INSERT INTO `permission_leng` VALUES ('74', '0', '供应商管理', '', '5', 'supMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-role', 'A', '', '2013-06-26 12:27:50', '2013-06-26 12:29:22', '1', '1');
INSERT INTO `permission_leng` VALUES ('75', '74', '供应商档案录入', '供应商管理', '1', 'supMain', 'F', 'Y', 'closed', 'jsp/supManager/supMain.jsp', 'icon-tip', 'A', '', '2013-06-26 12:28:55', '2013-06-26 16:28:17', '1', '1');
INSERT INTO `permission_leng` VALUES ('76', '75', '供应商新增', '供应商管理', '1', 'supAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 12:30:25', '2013-06-26 12:30:25', '1', '1');
INSERT INTO `permission_leng` VALUES ('77', '75', '供应商编辑', '供应商管理', '2', 'supEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 12:31:10', '2013-06-26 12:31:10', '1', '1');
INSERT INTO `permission_leng` VALUES ('78', '75', '供应商删除', '供应商管理', '3', 'supDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-06-26 12:31:59', '2013-06-26 14:05:55', '1', '1');
INSERT INTO `permission_leng` VALUES ('79', '75', '供应商联系人编辑', '供应商管理', '4', 'supConEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-26 14:06:44', '2013-06-26 15:45:59', '1', '1');
INSERT INTO `permission_leng` VALUES ('80', '8', '商品新增', '商品管理', '1', 'itemAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-26 15:37:38', '2013-06-26 15:37:38', '1', '1');
INSERT INTO `permission_leng` VALUES ('81', '8', '商品编辑', '商品管理', '2', 'itemEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-26 15:38:10', '2013-06-26 15:38:21', '1', '1');
INSERT INTO `permission_leng` VALUES ('82', '8', '商品删除', '商品管理', '3', 'itemDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-cancel', 'A', '', '2013-06-26 15:38:59', '2013-06-26 15:39:18', '1', '1');
INSERT INTO `permission_leng` VALUES ('83', '8', '商品导入', '商品管理', '4', 'itemImport', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-excel', 'I', '', '2013-06-26 15:41:54', '2013-06-26 16:30:12', '1', '1');
INSERT INTO `permission_leng` VALUES ('84', '68', '客户档案导入', '客户管理', '2', 'cstImport', 'F', 'Y', 'closed', 'sdf', 'icon-excel', 'A', '', '2013-06-26 16:27:14', '2013-06-26 16:27:14', '1', '1');
INSERT INTO `permission_leng` VALUES ('85', '74', '供应商档案导入', '供应商管理', '2', 'supImport', 'F', 'Y', 'closed', 'sdf', 'icon-excel', 'A', '', '2013-06-26 16:29:04', '2013-06-26 16:29:04', '1', '1');
INSERT INTO `permission_leng` VALUES ('86', '6', '物料档案导入', '物料管理', '2', 'itemImport', 'F', 'Y', 'closed', 'jsp/docView/view.jsp', 'icon-excel', 'A', '', '2013-06-26 16:31:43', '2013-07-12 12:14:15', '1', '1');
INSERT INTO `permission_leng` VALUES ('87', '0', '项目管理', '', '5', 'projectMgr', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-sys', 'A', '', '2013-06-27 12:02:43', '2013-06-27 12:02:43', '1', '1');
INSERT INTO `permission_leng` VALUES ('88', '87', '项目档案录入', '项目管理', '1', 'projectMain', 'F', 'Y', 'closed', 'jsp/project/projectMain.jsp', 'icon-adds', 'A', '', '2013-06-27 12:03:59', '2013-06-27 12:03:59', '1', '1');
INSERT INTO `permission_leng` VALUES ('89', '88', '项目新增', '项目档案录入', '1', 'projectAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-06-27 12:04:39', '2013-06-27 12:04:53', '1', '1');
INSERT INTO `permission_leng` VALUES ('90', '88', '项目编辑', '项目档案录入', '2', 'projectEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-edit', 'A', '', '2013-06-27 12:05:28', '2013-06-27 12:05:28', '1', '1');
INSERT INTO `permission_leng` VALUES ('91', '88', '项目删除', '项目档案录入', '3', 'projectDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-06-27 12:06:08', '2013-07-01 10:59:53', '1', '1');
INSERT INTO `permission_leng` VALUES ('92', '0', '数据备份', '', '7', 'dbBackUp', 'F', 'Y', 'closed', 'javascript:void(0);', 'icon-db', 'A', '', '2013-06-28 13:32:09', '2013-06-28 13:32:22', '1', '1');
INSERT INTO `permission_leng` VALUES ('93', '92', '数据备份', '数据备份', '1', 'dbBackUpMain', 'F', 'Y', 'closed', 'jsp/dbBackUp/dbBackUpMain.jsp', 'icon-end', 'A', '', '2013-06-28 13:34:21', '2013-06-28 13:50:29', '1', '1');
INSERT INTO `permission_leng` VALUES ('94', '93', '手动备份', '数据备份', '1', 'dbBackUpHand', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-pro', 'A', '', '2013-06-28 13:37:27', '2013-07-11 11:23:27', '1', '1');
INSERT INTO `permission_leng` VALUES ('95', '93', '定时备份', '数据备份', '2', 'dbBackUpTime', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-config', 'A', '', '2013-06-28 13:38:19', '2013-06-28 13:38:19', '1', '1');
INSERT INTO `permission_leng` VALUES ('96', '74', '采购单录入', '供应商管理', '3', 'ordPurMgr', 'F', 'Y', 'closed', 'jsp/orderPurchase/orderPurchaseMain.jsp', 'icon-adds', 'A', '', '2013-07-01 10:58:03', '2013-07-01 10:58:03', '1', '1');
INSERT INTO `permission_leng` VALUES ('97', '96', '采购单新增', '采购单录入', '1', 'ordPurAdd', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-adds', 'A', '', '2013-07-01 10:58:58', '2013-07-01 10:58:58', '1', '1');
INSERT INTO `permission_leng` VALUES ('98', '96', '采购单编辑', '采购单录入', '2', 'ordPurEdit', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-ok', 'A', '', '2013-07-01 10:59:44', '2013-07-01 11:01:00', '1', '1');
INSERT INTO `permission_leng` VALUES ('99', '96', '采购单删除', '采购单录入', '3', 'ordPurDel', 'O', 'Y', 'open', 'javascript:void(0);', 'icon-remove', 'A', '', '2013-07-01 11:00:44', '2013-07-01 11:00:44', '1', '1');
INSERT INTO `permission_leng` VALUES ('100', '68', '客户订单录入', '客户管理', '3', 'cstOrderMgr', 'F', 'Y', 'closed', 'jsp/orderSale/orderSaleMain.jsp', 'icon-end', 'A', '', '2013-07-08 15:20:54', '2013-07-08 15:23:53', '1', '1');
INSERT INTO `permission_leng` VALUES ('101', '1', '测试', null, '88', null, 'F', 'Y', null, null, '', 'A', null, '2017-11-28 22:27:42', null, null, null);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目资料';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='省份资料';
...
CREATE TABLE `role` (
  ...
  `MODIFYER` int(10) default NULL COMMENT '修改人',
  PRIMARY KEY  (`ROLE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统角色资料';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色权限资料';
...
CREATE TABLE `system_code` (
  ...
  `MODIFYER` int(10) default NULL COMMENT '修改人',
  PRIMARY KEY  (`CODE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统代码资料';
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'admin', 'admin', 'admin', '2', 'MIS', null, null, '928bfd2577490322a6e19b793691467e', '12@qq.com', null, null, null, null, null, null, null, 'A', null, '111111', null, null, null, null, '2013-06-14 00:00:00', '1', '1', '1111111');
INSERT INTO `users` VALUES ('2', 'root', 'root', 'root', '2', 'MIS', null, null, '88aec6f4d07b756329e42eb50c4688dd', '123@qq.com', null, null, null, null, null, null, null, 'A', null, '12312312323', null, null, null, null, '2013-06-19 00:00:00', '1', '1', '123');
...
INSERT INTO `users` VALUES ('15', '234', '234', '234', '1', '总经理室', null, null, '234', '234', null, null, null, null, null, null, null, 'A', null, '234234234', null, null, null, '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1', '342');
...
INSERT INTO `users` VALUES ('24', 'hy', 'ww', 'ee', '1', '总经理室', null, null, '928bfd2577490322a6e19b793691467e', '123', null, null, null, null, null, null, null, 'A', null, '123', null, null, null, '2013-06-21 09:19:56', '2013-06-24 15:00:14', '1', '1', '123');

-- ----------------------------
-- Table structure for `users_leng`
-- ----------------------------
DROP TABLE IF EXISTS `users_leng`;
CREATE TABLE `users_leng` (
  `USER_ID` int(11) NOT NULL auto_increment COMMENT '用户代码',
  `MYID` varchar(50) default NULL COMMENT '用户自编码',
  `ACCOUNT` varchar(50) default NULL COMMENT '账号',
  `NAME` varchar(50) default NULL COMMENT '名称',
...
-- ----------------------------
-- Records of users_leng
-- ----------------------------
INSERT INTO `users_leng` VALUES ('1', 'admin', 'admin', 'admin', '2', 'MIS', null, null, 'admin', '12@qq.com', null, null, null, null, null, null, null, 'A', null, '111111', null, null, null, null, '2013-06-14 00:00:00', '1', '1', '1111111');
INSERT INTO `users_leng` VALUES ('2', 'root', 'root', 'root', '2', 'MIS', null, null, 'root', '123@qq.com', null, null, null, null, null, null, null, 'A', null, '12312312323', null, null, null, null, '2013-06-19 00:00:00', '1', '1', '123');
INSERT INTO `users_leng` VALUES ('13', 'gsdgsgdsgdg', '123', 'twerywrt', '4', 'asdfasd', null, null, 'ert', 'ewrtewrt', null, null, null, null, null, null, null, 'I', null, '123123123', null, null, null, '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1', 'ert');
INSERT INTO `users_leng` VALUES ('14', 'ttt', 'ttt', 'ttttttt', '2', 'MIS', null, null, 'tt', 'ttt', null, null, null, null, null, null, null, 'I', null, '', null, null, null, '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1', 'tt');
INSERT INTO `users_leng` VALUES ('15', '234', '234', '234', '1', '总经理室', null, null, '234', '234', null, null, null, null, null, null, null, 'I', null, '234234234', null, null, null, '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1', '342');
INSERT INTO `users_leng` VALUES ('16', '123', '123', '123', '2', 'MIS', null, null, '123', '123', null, null, null, null, null, null, null, 'I', null, '123123123', null, null, null, '2013-06-14 00:00:00', '2013-06-14 00:00:00', '1', '1', '123');
INSERT INTO `users_leng` VALUES ('17', '12312', '31231', '2312', '5', '12333', null, null, '312', '123', null, null, null, null, null, null, null, 'I', null, '123123123123123123123324234', null, null, null, '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1', '3123');
INSERT INTO `users_leng` VALUES ('18', '123', '123', '3123', '4', 'asdfasd', null, null, '123', '123', null, null, null, null, null, null, null, 'I', null, '123123123123123', null, null, null, '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1', '132');
INSERT INTO `users_leng` VALUES ('19', '123', '124', '123', '2', 'MIS', null, null, '123', '123', null, null, null, null, null, null, null, 'I', null, '123123123', null, null, null, '2013-06-18 00:00:00', '2013-06-18 00:00:00', '1', '1', '123');
INSERT INTO `users_leng` VALUES ('20', '123', '3123', '123', '12', '123', null, null, '123', '123', null, null, null, null, null, null, null, 'I', null, '123123123123123', null, null, null, '2013-06-18 00:00:00', '2013-06-19 00:00:00', '1', '1', '123');
INSERT INTO `users_leng` VALUES ('21', 'test', 'test', 'test', '2', 'MIS', null, null, 'test', 'test@163.com', null, null, null, null, null, null, null, 'I', null, '', null, null, null, '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1', '111');
INSERT INTO `users_leng` VALUES ('22', '123', '123', '123', null, '', null, null, '123', '123', null, null, null, null, null, null, null, 'I', null, '123123123', null, null, null, '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1', '123');
INSERT INTO `users_leng` VALUES ('23', 'test', 'test', 'test', '1', '总经理室', null, null, 'test', 'atest', null, null, null, null, null, null, null, 'A', null, '测试账号', null, null, null, '2013-06-19 00:00:00', '2013-06-19 00:00:00', '1', '1', '123123');
INSERT INTO `users_leng` VALUES ('24', 'hy', 'ww', 'ee', '1', '总经理室', null, null, 'ee', '123', null, null, null, null, null, null, null, 'A', null, '123', null, null, null, '2013-06-21 09:19:56', '2013-06-24 15:00:14', '1', '1', '123');
...
CREATE TABLE `user_role` (
  ...
  KEY `FKBC16F46A3BCA327A` (`USER_ID`),
  CONSTRAINT `FKBC16F46A3BCA327A` FOREIGN KEY (`USER_ID`) REFERENCES `users_leng` (`USER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户角色资料表';
