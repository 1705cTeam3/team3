  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				 $dg = $("#dg");
				 $grid=$dg.datagrid({
					url : "<%=request.getContextPath()%>/findDbBackUpAllList.do",
					width : 'auto',
					...
					columns : [ [ {field : 'operloginId',title : '操作用户',width : parseInt($(this).width()*0.1)},
					              ...
					              {field : 'opertime',title : '备份日期',width : parseInt($(this).width()*0.1)},
					              {field : 'operMethod',title : '日志类型',width : parseInt($(this).width()*0.1),align : 'left'},
