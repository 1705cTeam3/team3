...
public class Users implements Serializable{
	...
	public String toString() {
		return "Users [userId=" + userId + ", myid=" + myid + ", account=" + account + ", name=" + name
				+ ", organizeId=" + organizeId + ", organizeName=" + organizeName + ", dutyId=" + dutyId + ", titleId="
				+ titleId + ", password=" + password + ", email=" + email + ", lang=" + lang + ", theme=" + theme
				+ ", firstVisit=" + firstVisit + ", previousVisit=" + previousVisit + ", lastVisits=" + lastVisits
				+ ", loginCount=" + loginCount + ", isemployee=" + isemployee + ", status=" + status + ", ip=" + ip
				+ ", description=" + description + ", questionId=" + questionId + ", answer=" + answer + ", isonline="
				+ isonline + ", created=" + created + ", lastmod=" + lastmod + ", creater=" + creater + ", modifyer="
				+ modifyer + ", tel=" + tel + ", authImage=" + authImage + "]";
	}
